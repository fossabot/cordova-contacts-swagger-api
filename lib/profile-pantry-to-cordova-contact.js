...
const assignAddresses = (contact, profilePantry) => {
    ...
    contact.addresses[GEO_ADDR_WORK].formatted =
    `${profilePantry.workStreet} ${profilePantry.mailCode}, ${profilePantry.workCity}, ${profilePantry.workState} ${profilePantry.workPostalCode} ${profilePantry.workCountry}`;
